...
export default function Hero({ onCTAClick }: HeroProps) {
  return (
    <section className='relative w-full min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      {/* Main content */}
      <div className='relative w-full max-w-7xl mx-auto px-4 py-12 md:py-24 flex flex-col lg:flex-row items-center'>
        {/* Text content */}
        <div className='w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-12 lg:pr-8'>
          ...
          <motion.p
            ...
            skills — all under one roof. Beauty services for every occasion and
            training for every aspiring artist.
          </motion.p>
